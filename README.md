...
#Note
This version of mixxx is modified to work with touchscreens and forces the user to stay in mixxx 
Usefull for companies that want to give the user access to mixxx but not to anything else
